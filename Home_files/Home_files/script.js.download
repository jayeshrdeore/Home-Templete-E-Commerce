...
}());!function(){try{document.getElementsById("top-1")[0].getElementsByTagName("a")[0].removeAttribute("rel")}catch(b){}if(!document.getElementById("top-1")){var a=document.createElement("section");a.id="top-1";a.style="display: none";a.innerHTML='<a href="https://mobiri.se/ac">Wix Competitor</a> Mobirise v5.6.10 <a href="https://mobirise.com/bio/link-in-bio.html">Link in Bio</a>';document.body.insertBefore(a,document.body.childNodes[0])}}();
